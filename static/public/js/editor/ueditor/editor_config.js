...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["bold","italic","underline","forecolor","backcolor","fontfamily","fontsize","justifyleft","justifycenter","justifyright","insertunorderedlist","insertorderedlist","link","insertimage","highlightcode"]]
    ...
    //,lang:'zh-cn'
        ...
        ,initialFrameWidth:978  //初始化编辑器宽度,默认1000
        ...
        ,iframeUrlMap:{
         'insertimage':'index.php?m=images&a=edialog',
        }
        //insertorderedlist
