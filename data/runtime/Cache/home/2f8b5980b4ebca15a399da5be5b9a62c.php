...
<?php if(is_array($arrFollowedUser)): foreach($arrFollowedUser as $key=>$item): ?><li class="clearfix" id="u$item[userid]">
        ...
        <div class="info">
          <h3>
              <a title="<?php echo ($item[username]); ?>" href="<?php echo U('people/index',array('id'=>$item[doname]));?>"><?php echo ($item[username]); ?></a>
...
<?php if($strUser[userid] == $visitor[userid]): ?><p class="pl2">
            &gt;&nbsp;<a href="<?php echo U('user/follow',array('userid'=>$strUser[userid]));?>">我关注的人(<?php echo ($strUser[count_follow]); ?>)</a>
        </p> 
<?php else: ?>
        <p class="pl2">
            &gt;&nbsp;<a href="<?php echo U('user/follow',array('userid'=>$strUser[userid]));?>"><?php echo ($strUser[username]); ?>关注的人(<?php echo ($strUser[count_follow]); ?>)</a>
        </p><?php endif; ?>              
<!---
        <p class="pl2">
