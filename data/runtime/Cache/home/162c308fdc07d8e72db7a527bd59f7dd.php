...
<div class="midder">
    ...
    <div class="mc">
        ...
        <div class="cleft">
        <form method="POST" action="<?php echo U('mall/create_ablum');?>"  enctype="multipart/form-data" onsubmit="return createCheck(this);">
        <table width="100%" cellpadding="0" cellspacing="0" class="table_1">
            <tr>
                <th>专辑名称：</th>
                <td><input type="text" value="" maxlength="63" size="31" name="title" tabindex="1" class="txt"    placeholder="请填写小组名称"></td>
            </tr>
            <tr>
                <th>专辑描述：</th>
                <td><textarea style="width:500px;height:200px;" name="content" tabindex="2" id="editor_mini" class="txt"   placeholder="请填写小组介绍"></textarea></td>
            </tr>
            <tr>
                <th>专辑分类：</th>
                <td>
